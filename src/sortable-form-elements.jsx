...
const {
  ...
  DatePicker, RadioButtons, Image, Rating, Tags, Signature, HyperLink, Download, Camera, Range, FileUpload,Button,Collapse
} = BaseFormElements;
...
FormElements.Collapse = SortableElement(Collapse);
